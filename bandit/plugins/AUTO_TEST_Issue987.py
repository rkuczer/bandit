...
from bandit.plugins.general_hardcoded_password import RE_CANDIDATES, RE_WORDS


class MyTestCase(unittest.TestCase):

    def test_complete_words(self):
        test_strings = ['passwords', 'secretpassword', 'pword', 'secret', 'pas', 'token', 'connection',
                        'my password is secret', 'secrete']
        expected_result = ['password', 'secrete', 'pwd', 'secret', 'pass', 'token', 'conn', 'password', 'secrete']
    ...
    def test_false_positives(self):
        test_strings = ['passenger', 'compass', 'passport', 'complicated', 'passive', 'passworded']
