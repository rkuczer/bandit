...
# test for fixes for the Multiline docstrings exclusion error #836
# bandit incorrectly marking an B101 assert used error with a
# #nosec comment in this code assert yaml.load("""{ # nosec
#         }""") == []
